...
function Reports() {
  ...
  const [tipoReporte, setTipoReporte] = useState('mensajeria'); // Asigna el valor deseado
  ...
  const generarReporteConBarraAvance = async () => {
    try {
    ...
    return (
      <>
        {localStorage.getItem('token') ? (
          <Layout>
            <div className="flex justify-center items-center bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-black p-8 bg-opacity-80">
              <div className="w-full">
                <label className="block mb-2">
                  ...
                  >
                    <option value="mensajeria">Reporte de Mensajería</option>
                    <option value="campanas">Reporte de Campañas</option>
                    <option value="conversaciones">Reporte de Conversaciones</option>
                  </select>
                </label>
                {tipoReporte === 'mensajeria' && (
                  <div className="mb-8">
