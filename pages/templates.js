...
const Reports = (props) => {
    ...
    if (session) {
        return ( <
                ...
                Container >
                <
                Button onClick = { handleToggleTemplateButtons }
                style = {
                ...
                showTemplateButtons && ( <
                    TemplateButtons > {
                        ['TEXT', 'IMAGE', 'VIDEO', 'DOCUMENT'].map(type => ( <
                            TemplateButton key = { type }
                            onClick = {
                                () => handleTemplateButtonClick(type)
                            } >
...

        {
            (selectedTemplateType === 'TEXT' || selectedTemplateType === 'IMAGE' || selectedTemplateType === 'VIDEO' || selectedTemplateType === 'DOCUMENT') && ( <
                ...
                *
                ...
                value = { elementName }
                onChange = {
                    (e) => setElementName(e.target.value)
                }
                /> <
                RequirementText >
                *
                ...
                onChange = {
                    (e) => setLanguageCode(e.target.value)
                } >
                <
...

                {
                    selectedTemplateType === 'TEXT' && ( <
                        ...
                        value = { exampleHeader }
                        onChange = {
                            (e) => setExampleHeader(e.target.value)
                        }
                        /> < /
                        label > <
                        />
            ...
            onChange = {
                (e) => setExampleContent(e.target.value)
            }
            /> < /
            StyledLabel >
